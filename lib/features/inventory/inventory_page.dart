  ...
  Widget _buildBody() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final low = qty <= product.minimumStock;
        return GlassPanel(
          ...
          child: ListTile(
            ...
            trailing: PopupMenuButton<String>(
              onSelected: (v) {
                if (v == 'add') _addStockFlow(product);
                if (v == 'adjust') {
              ...
              itemBuilder: (context) => const [
                PopupMenuItem(value: 'add', child: Text('Add / receive stock')),
                PopupMenuItem(value: 'adjust', child: Text('Adjust (reason required)')),
              ],
            ),
          ),
        );
